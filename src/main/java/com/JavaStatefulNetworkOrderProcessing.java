 ...
 * `$ bin/run-example
 * org.apache.spark.examples.streaming.JavaStatefulNetworkWordCount localhost
 * 9999`
 */
public class JavaStatefulNetworkOrderProcessing {
        ...
        public static void main(String[] args) throws Exception {
                ...
                List<Tuple2<String, Integer>> tuples = Arrays.asList(new Tuple2<>("hello", 0),
                                new Tuple2<>("world", 0));
                ...
                JavaDStream<Long> count = stateDstream.count();
                count.print();
